...
function createTag(newTag, createAnnotatedTag, GITHUB_SHA, tagMessage) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (createAnnotatedTag) {
            ...
            annotatedTag = yield octokit.git.createTag(Object.assign(Object.assign({}, github_1.context.repo), { tag: newTag, message: tagMessage, object: GITHUB_SHA, type: 'commit' }));
        }
